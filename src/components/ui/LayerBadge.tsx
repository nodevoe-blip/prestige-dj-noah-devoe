...
export function LayerBadge({
  ...
  if (layer === "noah") {
    return (
      ...
      >
        <span className="text-wine-bright">&#9679; Noah, personally</span>
        <span>— his own bookings, his own mixes, his own crowd.</span>
        <Link href="/wedding-dj" className="text-brass underline decoration-dotted underline-offset-2 hover:text-brass-bright">
  ...
  return (
    <p
      className={`inline-flex flex-wrap items-center gap-x-2 gap-y-1 rounded-sm border ${border} px-3 py-1.5 font-mono text-[11px] uppercase tracking-wider ${textMuted}`}
    >
      <span className="text-brass">&#9679; Prestige, the company</span>
      <span>— a full team of DJs, one of whom is Noah.</span>
      <Link href="/noah-devoe" className="text-wine-bright underline decoration-dotted underline-offset-2 hover:text-wine">
